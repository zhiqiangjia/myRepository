...
public class CalenderUtils {
    ...
    private static final LocalDateTime MIN_DATE_TIME = LocalDateTime.parse("1900-01-30 08:00",
            DateTimeFormatter.ofPattern(PATTERN));
    private static final LocalDateTime MAX_DATE_TIME = LocalDateTime.parse("2049-12-31 20:00",
            DateTimeFormatter.ofPattern(PATTERN));
    ...
    public static final String[] monthAlias = { "正月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月", "十一月",
            "腊月" };
    public static final String[] dayAlias = { "初一", "初二", "初三", "初四", "初五", "初六", "初七", "初八", "初九", "初十", "十一", "十二",
    ...
    public static final String[][] nianShangQiYue = { { "丙寅", "戊寅", "庚寅", "壬寅", "甲寅" },
    ...
    public static final String[][] riShangQiShi = { { "甲子", "丙子", "戊子", "庚子", "壬子" }, { "乙丑", "丁丑", "己丑", "辛丑", "癸丑" },
    ...
    public static BirthInfo guess(String date) {
        ...
        if (dateTime.isBefore(MIN_DATE_TIME) || dateTime.isAfter(MAX_DATE_TIME)) {
            throw new RuntimeException("超出我能计算的时间范围（1900-01-30 08:00 - 2049-12-31 20:00）");
        }
        ...
        String lunarDay = monthAlias[lunarMonth - 1] + dayAlias[lunarDayOfMonth - 1];
    ...
    public static void main(String[] args) {
        System.out.println(guess("2018-02-19 08:45"));
    }
